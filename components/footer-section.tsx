export default function FooterSection() {
  return (
    <div className="w-full pt-10 flex flex-col justify-center items-center">
      {/* Main Footer Content */}
      <div className="self-stretch h-auto flex flex-col justify-center items-center pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-center items-center gap-8">
          {/* Brand Section */}
          ...
          <div className="text-center text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans">
